...
*   **Developer Notes**:
    ...
    *   **"Start Now" Navigation (DECISION NEEDED)**:
        *   Current spec implies: "Start Now" → Exercise Detail (2.03) → Back → Exercise Picker (2.01)
        *   Alternative: "Start Now" → Exercise Detail (2.03) → Back → Active Workout Hub (2.02)
        *   **Recommendation**: Return to Active Workout Hub (2.02) after Exercise Detail, as user has "committed" to starting the workout. Returning to picker feels like a step backward.
